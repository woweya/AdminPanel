...
const Home = ({ Item, ItemExtra}) => {
  ...
  <main className="home">
      ...
      <div className="table" style={{marginTop: '2rem', display:'flex', justifyContent: 'center'}}>
      <Tabella utentiLista={utentiLista} setUtentiLista={setUtentiLista} />
      </div>
